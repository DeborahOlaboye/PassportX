...
export class BadgeIssuanceAnalytics {
  private logger: any;
  private cache: Map<string, { data: IssuanceMetrics; timestamp: number }> =
    new Map();
  ...
  private async getDailyIssuance(
    days: number
  ): Promise<IssuanceMetrics['dailyIssuance']> {
  ...
  private async getWeeklyIssuance(
    weeks: number
  ): Promise<IssuanceMetrics['weeklyIssuance']> {
  ...
  private async getMonthlyIssuance(
    months: number
  ): Promise<IssuanceMetrics['monthlyIssuance']> {
