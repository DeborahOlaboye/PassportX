...
export class ChainhookEventCache {
  ...
  private getDefaultLogger() {
    return {
      debug: (msg: string, ...args: any[]) =>
        console.debug(`[EventCache] ${msg}`, ...args),
      info: (msg: string, ...args: any[]) =>
        console.info(`[EventCache] ${msg}`, ...args),
      warn: (msg: string, ...args: any[]) =>
        console.warn(`[EventCache] ${msg}`, ...args),
      error: (msg: string, ...args: any[]) =>
        console.error(`[EventCache] ${msg}`, ...args),
    };
  }
  ...
  set(event: any, value: any): void {
    ...
    this.logger.debug(
      `Cache set for key: ${key} (size: ${this.cache.size}/${this.config.maxSize})`
    );
  }
