  ...
  private getDefaultLogger() {
    return {
      debug: (msg: string, ...args: any[]) =>
        console.debug(`[ChainhookEventLogger] ${msg}`, ...args),
      info: (msg: string, ...args: any[]) =>
        console.info(`[ChainhookEventLogger] ${msg}`, ...args),
      warn: (msg: string, ...args: any[]) =>
        console.warn(`[ChainhookEventLogger] ${msg}`, ...args),
      error: (msg: string, ...args: any[]) =>
        console.error(`[ChainhookEventLogger] ${msg}`, ...args),
    };
  }
