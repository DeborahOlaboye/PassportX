...
export function sortNotificationsByStatus(notifications: Notification[]): Notification[] {
...
export function sortNotificationsByType(notifications: Notification[]): Notification[] {
  return [...notifications].sort((a, b) => {
...
export function filterNotificationsByStatus(notifications: Notification[], status: NotificationStatus): Notification[] {
