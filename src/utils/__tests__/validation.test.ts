...
describe('Validation Utilities', () => {
  describe('isValidStacksAddress', () => {
    test('accepts valid Stacks mainnet address', () => {
      expect(
        isValidStacksAddress('SP2J6ZY48GV6RDZV4R2X5M9Y77XQSRZ2GQ3QTPH8KQ')
      ).toBe(true);
    });

    test('accepts valid Stacks testnet address', () => {
      expect(
        isValidStacksAddress('STFUJC6AKPVJ3BLZM45YMQR57W4FZQG4MFDM2CEA')
      ).toBe(true);
    });
    ...
    test('rejects address with wrong prefix', () => {
      expect(
        isValidStacksAddress('AP2J6ZY48GV6RDZV4R2X5M9Y77XQSRZ2GQ3QTPH8KQ')
      ).toBe(false);
    });
  ...
  describe('validateUserIdParameter', () => {
    ...
    test('accepts valid Stacks address', () => {
      const result = validateUserIdParameter(
        'SP2J6ZY48GV6RDZV4R2X5M9Y77XQSRZ2GQ3QTPH8KQ'
      );
      expect(result.isValid).toBe(true);
