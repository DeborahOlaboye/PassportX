...
describe('Contract Hooks - Error Handling Tests', () => {
  ...
  describe('useIssueBadge - Error Handling', () => {
    ...
    it('should handle insufficient balance error', async () => {
      ...
      BadgeIssuerManager.prototype.issueBadge = jest
        .fn()
        .mockRejectedValue(insufficientError);
    ...
    it('should handle reorg error', async () => {
      const BadgeIssuerManager =
        require('@/lib/contracts/badgeContractUtils').BadgeIssuerManager;
      const reorgError = new Error(
        'Blockchain reorganization detected - transaction reverted'
      );

      BadgeIssuerManager.prototype.issueBadge = jest
        .fn()
        .mockRejectedValue(reorgError);
