...
export default function ProfileSettingsPage() {
  ...
  const [customUrlAvailable, setCustomUrlAvailable] = useState<boolean | null>(
    null
  );
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setProfileData((prev) => ({
                        ...prev,
                        customUrl: sanitizeCustomUrl(e.target.value),
                      }))
                    }
          ...
          <div className="flex justify-end">
            <button
              ...
              disabled={
                loading ||
                (profileData.customUrl.length >= 3 &&
                  customUrlAvailable === false)
              }
