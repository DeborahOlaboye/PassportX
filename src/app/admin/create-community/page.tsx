...
const CommunityCreationForm = dynamic(
  () => import('@/components/forms/CommunityCreationForm'),
  {
...
export default function CreateCommunityPage() {
  ...
  const { createCommunity, isLoading, error, success, txId } =
    useCreateCommunity();
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-md mx-auto text-center">
          ...
          <p className="text-gray-600 mb-4">
            Your community "{communityName}" has been successfully created on
            the blockchain.
          </p>
        ...
        <div className="text-center py-12">
          ...
          <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
            <p className="text-sm text-blue-800">
              <strong>Note:</strong> This may take a few moments. Please don't
              close this page.
            </p>
          </div>
        </div>
