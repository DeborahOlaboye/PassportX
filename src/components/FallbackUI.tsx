...
export const WalletErrorFallback: React.FC<{
  error?: Error;
  reset?: () => void;
}> = ({ error, reset }) => (
  <FallbackUI
...
export const BadgeErrorFallback: React.FC<{
  error?: Error;
  reset?: () => void;
}> = ({ error, reset }) => (
  <FallbackUI
...
export const CommunityErrorFallback: React.FC<{
  error?: Error;
  reset?: () => void;
}> = ({ error, reset }) => (
  <FallbackUI
...
export const TransactionErrorFallback: React.FC<{
  error?: Error;
  reset?: () => void;
}> = ({ error, reset }) => (
  <FallbackUI
...
export const AnalyticsErrorFallback: React.FC<{
  error?: Error;
  reset?: () => void;
}> = ({ error, reset }) => (
  <FallbackUI
...
export const ActivityErrorFallback: React.FC<{
  error?: Error;
  reset?: () => void;
}> = ({ error, reset }) => (
  <FallbackUI
