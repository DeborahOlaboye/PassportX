...
interface ErrorNotificationContextType {
  notifications: ErrorNotification[];
  addNotification: (error: PassportXError, options?: NotificationOptions) => void;
...
export const ErrorNotificationProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const addNotification = useCallback((error: PassportXError, options: NotificationOptions = {}) => {
    const {
