...
export const NetworkSwitchConfirmDialog: React.FC<
  NetworkSwitchConfirmDialogProps
> = ({ isOpen, onClose, onConfirm, targetNetwork, currentNetwork }) => {
      ...
      <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4">
        ...
        <div className="mb-6">
          <p className="text-sm text-gray-600 mb-3">
            ...
            <span
              className={`font-semibold ${getNetworkColor(currentNetwork)}`}
            >
